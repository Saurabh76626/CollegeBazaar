...
<html class="no-js" lang="en">
  ...
  <body style="background-image: url('images/login.jpg'); background-size: cover;">
    ...
    <form method="POST" action="verify.php" style="margin-top:200px;margin-left: 50px;">
      <div class="row">
        <div class="small-8">

          <div class="row">
            <div class="small-4 columns">
              <label for="right-label" class="right inline" style="color: #fff">Email</label>
            </div>
            <div class="small-8 columns">
              <input type="email" id="right-label" placeholder="" name="username" required="">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
              <label for="right-label" class="right inline" style="color: #fff">Password</label>
            </div>
            <div class="small-8 columns">
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer>
           <p style="text-align:center; font-size:0.8em; color: #fff;">&copy; College Bazaar. All Rights Reserved.</p>
        </footer>
